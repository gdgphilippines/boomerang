		...
		$.ajax({
			...
			success: function(events) {
				...
				if(events.items.length == 0)
					...
					$("#upcoming").html('<h3>'+event.title+'</h3><small>'+dateFormat(datex, "dddd, mmmm dS, yyyy, h:MM TT")+'</small><p>'+tmp.textContent.split(/\s+/).slice(0,20).join(" ")+"..."+'</p><a class="action_button" href="https://developers.google.com/events/'+event._id+'/" target="_blank"><i class="mdi mdi-eye"></i></a>');
				}
			}
		});
	},
